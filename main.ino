...
void output_data {
  // Goal: export the data via I2C to CFE.
  // Implementation: 
  // Geiger counter data: 2
  // Plasma probe data: 2
  // Radio data: 3
  // Export an array of 2+2+3 = 7 as I2C to CFE
   
}


/* The 2014 code is appended below. 
 * It needs additional commenting before the Arduino code above can be executed.
#include "predef.h"
#include <stdio.h>
#include <ctype.h>
